...
<button
  disabled={!isWeb3Injected}
  class="mt-auto border border-transparent py-2 rounded-lg bg-gray-800 disabled:cursor-not-allowed text-white font-medium transition ease-in-out duration-300 hover:border-indigo-500"
  on:click={connect}
>
  Connect wallet
</button>
